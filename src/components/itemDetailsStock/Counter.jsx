...
const Counter = ({stock,cantidad,setCantidad,estadoAgregar,producto}) => {
  ...
  return (
    <>
      ...
      {estadoAgregar===true && cantidad>0 ? <StatusCartButton estado={true} producto={producto} cantidad={cantidad} />:<StatusCartButton estado={false}/>}
      <div>
