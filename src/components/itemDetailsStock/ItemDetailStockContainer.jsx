...
const ItemDetailStockContainer = ({talles}) => {
  ...
  return (
    <div>
        ...
        <Counter stock={stock} cantidad={cantidad} setCantidad={setCantidad} estadoAgregar={estadoAgregar} setEstadoAgregar={setEstadoAgregar} />
    </div>
  )
}
